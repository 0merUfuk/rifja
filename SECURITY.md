...
[GitHub private vulnerability reporting](https://github.com/0merUfuk/session-visualizer/security/advisories/new).
...
Session Visualizer reads explicitly registered local inputs and stores its own
...
collection and queries operate offline. See the [threat model](docs/session-visualizer-threat-model.md).
