...
Large target declared before optimization: >=1,000 sessions, ~250,000 records, ~250 MiB varied sources, >=20 repositories including worktrees/history. Budgets: cold <=120s, unchanged <=5s, ~100-record append <=2s, indexed query p95 <=1s, peak ingestion <=512MiB. Measure Git and complete resume separately. No budget weakening after a failure. No publication, remote CI or new public license gate.
