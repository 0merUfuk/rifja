...
def default_home() -> Path:
    if os.environ.get("SESSION_VISUALIZER_HOME"):
        return Path(os.environ["SESSION_VISUALIZER_HOME"]).expanduser()
    if sys.platform == "darwin":
        return Path.home() / "Library" / "Application Support" / "SessionVisualizer"
    return (
